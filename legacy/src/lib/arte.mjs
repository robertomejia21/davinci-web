...
/* Tornillo aéreo de Leonardo — el isotipo hecho boceto */
export const tornilloAereo = (clase = "") => html`
<svg class="${clase}" viewBox="0 0 320 340" fill="none" role="img" aria-label="Boceto del tornillo aéreo de Leonardo" style="width:100%;height:auto">
  <g stroke="currentColor" stroke-width="1.4" opacity="1" stroke-linecap="round">
  ...
  <g stroke="currentColor" stroke-width=".7" opacity=".35" stroke-dasharray="3 5">
    <path d="M18 96h284M40 140h240M70 182h180"/>
  </g>
  <g fill="currentColor" opacity=".5">
    <circle cx="160" cy="96" r="2.6"/><circle cx="160" cy="182" r="2.2"/><circle cx="160" cy="252" r="2"/>
  </g>
</svg>`;

/* Boceto de una interfaz: el códice convertido en software */
export const bocetoUI = (clase = "") => html`
<svg class="${clase}" viewBox="0 0 420 300" fill="none" role="img" aria-label="Boceto renacentista de una interfaz de software" style="width:100%;height:auto">
  <rect x="14" y="14" width="392" height="272" rx="12" stroke="currentColor" stroke-width="1.4" opacity=".8"/>
  <path d="M14 56h392" stroke="currentColor" stroke-width="1" opacity=".4"/>
  <g stroke="currentColor" stroke-width="1" opacity=".5">
    <circle cx="36" cy="35" r="5"/><path d="M52 35h60M52 42h34" opacity=".6"/>
  </g>
  ...
  <g stroke="currentColor" stroke-width="1.6" opacity=".9" stroke-linecap="round">
  ...
  <g stroke="currentColor" stroke-width=".7" opacity=".3" stroke-dasharray="4 6">
    <path d="M210 14v272M14 160h392"/>
  </g>
</svg>`;

/* Espiral áurea — deco */
export const espiral = (clase = "") => html`
<svg class="${clase}" viewBox="0 0 200 200" fill="none" aria-hidden="true" style="width:100%;height:auto">
  <g stroke="currentColor" stroke-width="1.2" opacity=".75">
    ...
    <path d="M196 123A119 119 0 0077 4" stroke-width="1.6" opacity=".9"/>
    <path d="M77 123a45 45 0 0045-45" stroke-width="1.6" opacity=".9"/>
    <path d="M122 168a27 27 0 00-27-27" stroke-width="1.6" opacity=".9"/>
  </g>
</svg>`;
